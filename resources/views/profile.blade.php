            ...
            <div class="profile_info">
                <div class="cart">
                        ...
                        <div class="info">
                            ...
                            <p class="desc">
                                leitora de livros, apaixonada por café e por gatos.
                            </p>
                        </div>
                </div>
            </div>
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                        <div id="posts_sec" class="post">
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/336407/pexels-photo-336407.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/27576514/pexels-photo-27576514.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/33522921/pexels-photo-33522921.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/31078816/pexels-photo-31078816.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/25182689/pexels-photo-25182689.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                        <div id="saved_sec" class="post">
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/20409048/pexels-photo-20409048.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/34793646/pexels-photo-34793646.jpeg" alt="">
                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                        <div id="tagged" class="post">
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/12960723/pexels-photo-12960723.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-fluid item_img" src="https://images.pexels.com/photos/6001679/pexels-photo-6001679.jpeg" alt="">
                            </div>
                        </div>
                    </div>
